...
namespace Ecliptix.Memberships.Persistor.Migrations
{
    ...
    [Migration("20250916150756_StoredProcedureSupport")]
    partial class StoredProcedureSupport
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Ecliptix.Memberships.Persistor.Schema.StoredProcedures.Models.MembershipResult", b =>
                {
                    b.Property<string>("ErrorMessage")
            ...
            modelBuilder.Entity("Ecliptix.Memberships.Persistor.Schema.StoredProcedures.Models.OtpVerificationResult", b =>
                {
                    b.Property<string>("ErrorMessage")
                        .HasColumnType("nvarchar(max)");

                    b.Property<Guid?>("FlowUniqueId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Ecliptix.Memberships.Persistor.Schema.StoredProcedures.Models.PhoneNumberResult", b =>
                {
                    b.Property<bool>("IsNewlyCreated")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Ecliptix.Memberships.Persistor.Schema.StoredProcedures.Models.VerificationFlowResult", b =>
                {
                    b.Property<Guid?>("FlowUniqueId")
                        .HasColumnType("uniqueidentifier");
